...
import com.jumplife.videoloader.QQLoader;
...
public class VitamioControllerView extends FrameLayout {
    ...
    public SparseArray<String> parseLink(String videoUrl, SparseArray<String> mVideoQuiltyLink) {
    	...
    	if (videoUrl.contains("dailymotion")) {
			...
			mVideoQuiltyLink = FiveSixLoader.Loader(videoUrl);
			return mVideoQuiltyLink;
		} else if (videoUrl.toLowerCase(Locale.getDefault()).contains("v.qq.com")) {
			mVideoQuiltyLink = QQLoader.Loader(videoUrl);
			return mVideoQuiltyLink;
		}
		return mVideoQuiltyLink;
    }
